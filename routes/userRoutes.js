...
router.post('/addClothes',auth,upload.single('image'),addClothes); //add clothes to closet and upload image to cloudinary
...
router.post('/generateOutfits',auth,generateOutfits); //generate outfits with gemini
